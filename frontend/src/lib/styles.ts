export const FORM_CONTROL_BASE = [
  'w-full px-3 py-2.5 text-sm border border-slate-200 rounded-lg text-slate-800 bg-white',
  'focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-500 focus-visible:border-transparent',
